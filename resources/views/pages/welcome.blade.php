        ...
        <div id="rev-slider-1" class="rev_slider gradient-slider" style="display:none" data-version="5.4.5">
            <ul>
                ...
                <li data-transition="crossfade">
                    <!-- MAIN IMAGE -->
                    <img src="{{asset($carousels[0]->url)}}" alt="Image" title="Image" data-bgposition="center center"
                ...
                <li data-transition="crossfade">
                    <!-- MAIN IMAGE -->
                    <img src="{{asset($carousels[1]->url)}}" alt="Image" title="Image" data-bgposition="center center"
                        data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg"
                        data-no-retina="">
                    <!-- LAYER NR. 1 -->
                ...
                <li data-transition="crossfade">
                    <!-- MAIN IMAGE -->
                    <img src="{{asset($carousels[2]->url)}}" alt="Image" title="Image" data-bgposition="center center"
                        data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg"
                        data-no-retina="">
                    <!-- LAYER NR. 1 -->
